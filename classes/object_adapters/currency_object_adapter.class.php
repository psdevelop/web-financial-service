...
class CurrencyObjectAdapter extends ObjectAdapter implements ObjectManipInterface  {
     ...
     function __construct($table_name, $class_name)    {
        ...
        $this->fields_prev_text_array = array("id"=>"ID","currency_name"=>"Наименование валюты");
        $this->fields_width_array = array("id"=>1,"currency_name"=>75);
        $this->select_display_field = "currency_name";
        $this->manip_form_template = "<table><tr><td>***___currency_name</td><td></td><td>***___id</td></tr>
            </table>";
     ...
     function writeTableHeader($linked_props)    {
        ...
        parent::write_header_td("Наименование валюты",75);
        echo "</tr>";
     }
     ...
     function writeTableRow($object, $linked_props)    {
        ...
        parent::write_td($object->currency_name,75);
     }
