...
function initHighcharts()   {
    ...
    if (document.getElementById('category_detail_container')&&
        document.getElementById('category_master_container'))    {
        
        function createCategoryMasterPieSpline(graph_data) {
            ...
            chart = new Highcharts.Chart({
                chart: {
                    renderTo: 'category_master_container',
                ...
                title: {
                    text: 'Движения средств по категориям'
                },
                tooltip: {
                ...
                plotOptions: {
                    pie: {
                        ...
                        dataLabels: {
                            ...
                            formatter: function() {
                                return '<b>'+ this.point.name +'</b>: '+ this.percentage +' %---'+this.point.cat_id;
                            }
                        }
                    }
                },
                series: [{
                    ...
                    events: {
                          click: function(event) {
                              ...
                              //alert(result);//print_r(event.point.series));
                            
                                  $.ajax({
                                        type: "POST",
                                        url: "out_table.php",
                                        data: "class_name=FinanceActData&request_mode=out_report_mode&entity_suffix=_account&report_name=balance_chart&result_type=json&fca_category_id="+event.point.cat_id,//event.point.cat6_id,
                                        dataType: "json",
                                        success: function(json_data) {

                                            createCategoryDetailSpline(json_data);
        ...
        function createCategoryDetailSpline(graph_data) {
            
                var chart;
            
                chart = new Highcharts.Chart({
                chart: {
                    renderTo: 'category_detail_container',
                    type: 'spline'
                },
                title: {
                    text: 'Временной график движений по выделенной категории или всем'
                },
                subtitle: {
                    text: 'Аналитика финансов kudapotratil.ru'
                },
                xAxis: {
                    //type: 'datetime'
                    //categories: json_data.month_date_point
                    categories: graph_data.month_date_point
                },
                yAxis: {
                    title: {
                        text: 'Сумма, руб'
...
//                    }
                ...
                series: [{
                        name: 'Приход',
                        data: graph_data.month_income//[7.0, 6.9, 9.5, 14.5, 18.4, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
                    }, {
                        name: 'Расход',
                        data: graph_data.month_outcome//[3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
                    }, {
                        name: 'Итого',
                        data: graph_data.month_summ//[3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
                    }]
                ,
                navigation: {
                    menuItemStyle: {
        ...
        //END OF function createCategoryDetailSpline
        
        //createCategoryMasterPieSpline(null);
        //createCategoryDetailSpline(null); 
        
        $.ajax({
            type: "POST",
            url: "out_table.php",
            data: "class_name=InOutCats&request_mode=out_report_mode&entity_suffix=_account&report_name=outcome_categories_diagramm&result_type=json",
            dataType: "json",
            success: function(json_data) {
                
                createCategoryMasterPieSpline(json_data);
    ...
    if (document.getElementById('stack_chart_container'))    {
        $.ajax({
            type: "POST",
            url: "out_table.php",
            data: "class_name=FinanceActData&request_mode=out_report_mode&entity_suffix=_account&report_name=root_income_percents_chart&result_type=json",
            dataType: "json",
            success: function(json_data) {
                ...
                chart = new Highcharts.Chart({
                            chart: {
                                renderTo: 'stack_chart_container',
                                type: 'column'
                            },
                            title: {
                                text: 'Отчет по структуре доходов'
                            },
                            xAxis: {
                                categories: json_data.categories//['Apples', 'Oranges', 'Pears', 'Grapes', 'Bananas']
                            },
                            yAxis: {
                                min: 0,
                                title: {
    ...
    if (document.getElementById('line_chart_container'))    {
        $.ajax({
            type: "POST",
            url: "out_table.php",
            ...
            success: function(json_data) {
                ...
                chart = new Highcharts.Chart({
                    ...
                    title: {
                        text: 'Балансовый отчет'
                    },
                    subtitle: {
                        text: 'kudapotratil.ru'
                    },
                    xAxis: {
                        categories: json_data.month_date_point//['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
                    },
                    yAxis: {
                        title: {
                            text: 'Сумма, руб'
                    ...
                    series: [{
                        name: 'Приход',
                        data: json_data.month_income//[7.0, 6.9, 9.5, 14.5, 18.4, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
                    }, {
                        name: 'Расход',
                        data: json_data.month_outcome//[3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
                    }, {
                        name: 'Итого',
                        data: json_data.month_summ//[3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
                    }]
                });
    ...
    if (document.getElementById('master_detail_chart_container'))    {
        $.ajax({
            type: "POST",
            url: "out_table.php",
            data: "class_name=FinanceActData&request_mode=out_report_mode&entity_suffix=_account&report_name=balance_chart&result_type=json",
            ...
            var masterChart,
                ...
                function createMaster() {
                    masterChart = new Highcharts.Chart({
                        ...
                        series: [{
                            ...
                            data: json_data.month_income//data
                        }],
                ...
                var $container = $('#master_detail_chart_container')
    ...
    if (document.getElementById('pie_chart_container'))
    $.ajax({
            type: "POST",
            url: "out_table.php",
            data: "class_name=InOutCats&request_mode=out_report_mode&entity_suffix=_account&report_name=outcome_categories_diagramm&result_type=json",
