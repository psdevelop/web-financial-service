...
AUTO_INCREMENT=2 AVG_ROW_LENGTH=24 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=1327 AVG_ROW_LENGTH=40 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
INSERT INTO `payment_systems` (`payment_system_id`, `payment_system_name`, `ps_order_counter`, `ps_custom_name`) VALUES 
  (1,'ASSIST_PS',7,NULL);
COMMIT;
...
#
# Data for the `sessions` table  (LIMIT 617,500)
#
